...
<head>
    ...
    <title>Gym | Alterar Treino</title>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb-text">
                        <h2>ALTERAR TREINO</h2>
                        <div class="bt-option">
                            <a href="./index.php">Início</a>
                            <a href="./listar.php">Listar</a>
                            <span>Alterar Treino</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="contact-section spad">
        <div class="container">
			<div class="section-title contact-title">
						<span>Altere o Treino</span>
						<h2>Altere o treino dos seus clientes!</h2>
					</div>
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="leave-comment">
                        <form action="../Controle/phpAlterarTreino.php" method="post" name="frmLoginCadTreino" autocomplete="off">
                            ...
                            <select name="selecao" id="selectCadastroTreino" class="meuSelect">
                                ...
                                <option value="C" <?php if($tipo == 'C'){ echo 'selected';}?> id="optionCadastro">Treino C</option>
		                    </select>
							...
							<select name="idEquipamento" id="idEquipamento" class="meuSelect" required>
								<?php
									$treinoDAO->selecionarEquipamento($conexao, $codigo);
								?>
							</select>
